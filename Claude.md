...
- **Civic score keys off verified/resolved reports, not submitted reports.** The rejection penalty (-40) needs to stay larger in expected value than the reward for a fabricated report — this is a spam-economics decision, not just a number.
